...
public final class SessionApplier {
    ...
    public static boolean apply(String username, String uuidStr, String accessToken, AccountManager.AccountType type) {
        ...
        try {
            ...
            // The session is private/final in MinecraftClient. This fallback reflection targets
            // the mapped field directly and is kept here because it works across the client jars
            // used by the supported Fabric 1.21.11 runtime.
    ...
    private static String insertDashes(String flat) {
        return flat.replaceFirst("(\\p{XDigit}{8})(\\p{XDigit}{4})(\\p{XDigit}{4})(\\p{XDigit}{4})(\\p{XDigit}+)", "$1-$2-$3-$4-$5");
    }
